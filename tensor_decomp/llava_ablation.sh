...
# ============================================================================
# llava_ablation.sh  (DySeg-DPP — LLaVA-OneVision / LLaVA-Video)
#
# 消融实验: 扫描核心参数 (DySeg + DPP + Top-K Soft Fusion)
#
# Pipeline:
#   SigLIP ViT (完全不动) → mm_projector → 2D Pooling (27×27 → 13×13 = 169 tokens/frame)
...
#   3. w_query                  — DPP importance 中 query score 权重
...
PRETRAINED="/mnt/bn/zhibo-demo/huiqiang/zhibo_demo/LLM_models/llava-onevision-qwen2-7b-ov"
ATTN_IMPLEMENTATION="flash_attention_2"
CONV_TEMPLATE="qwen_1_5"
MM_SPATIAL_POOL_STRIDE=2
MM_SPATIAL_POOL_MODE="bilinear"
MM_NEWLINE_POSITION="one_token"        # one_token frame  no_token
...
BASE_DYSEG_THRESHOLD=0.4      # 越小组越少
...
# ── DPP Anchor 选择方法 ──
BASE_ANCHOR_METHOD=dpp        # facility_location  facility_location_optimized   dpp  dpp_optimized

# ── DySeg 分段控制 ──
BASE_MIN_SEGMENT_NUM=12
BASE_COMPLEMENTARY_SEGMENT=True

# ── 残差池参数 ──
BASE_RES_IMP_ALPHA=0.3
BASE_RES_METHOD=dpc_knn     # dpc_knn dpp

# ############################################################################
# ██  评测任务
# ############################################################################
# TASKS="videomme,longvideobench_val_v,egoschema,mvbench,mlvu_test,perceptiontest_val_mc"
...
OUTPUT_DIR="./eval_results/llava_ablation_study"
LOG_DIR="./eval_logs/llava_ablation_study"
mkdir -p ${OUTPUT_DIR}
mkdir -p ${LOG_DIR}
...
run_experiment() {
    ...
    local P_WQ=${ABL_W_QUERY:-$BASE_W_QUERY}
...
# # ============================================================================
# # Ablation 3: W_QUERY 扫描 (DPP importance query weight)
# # ============================================================================
# echo ""
# echo "################################################################"
# echo "# Ablation 3: W_QUERY"
# echo "################################################################"
# for WQ in 0.05 0.1 0.15 0.2; do
#     ABL_W_QUERY=${WQ} run_experiment "WQ${WQ}"
# done
...
# echo "################################################################"
# for DST in 0.4 0.5 0.6 0.70 0.80 ; do
...
# echo "################################################################"
# for CFL in   0.5 0.75 0.9 1.0; do
...
# echo "################################################################"
# for FM in   softmax softmax_imp; do
...
echo ""
echo "================================================================"
echo " All LLaVA-OneVision ablation experiments complete!"
...
echo " Ablation 3  - W_QUERY:                 0.0 / 0.05 / 0.1 / 0.15 / 0.2"
